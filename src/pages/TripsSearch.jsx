          ...
          <div className="main">
            <nav aria-label="breadcrumb">
              <ol className="breadcrumb">
                ...
                <li className="breadcrumb-item active trip-text-m fw-bold" aria-current="page">
                  探索旅程
                </li>
              </ol>
            </nav>
            <div className="d-md-flex align-items-center align-items-md-start gap-24 mt-4">
              <SideBar filters={filters} setFilters={setFilters} onUpdateFilter={onUpdateFilter} />
              <div className="flex-grow-1">
                <div className="filter-container d-flex">
                  <div className="flex-grow-1">
                    <span className="trip-text-m">搜尋到</span>
                    <span className="trip-text-m">{handleTotalCount()}</span>
                    <span className="trip-text-m">個結果</span>
                  </div>
...
function SideBar({ filters = {}, setFilters = () => {}, onUpdateFilter = () => {} }) {
    ...
    <>
      <div className="tripsSreach-sideBar">
        <div className="filter-group">
          ...
          <input
            type="text"
            className="input w-100 ps-2 trip-text-m trip-text-gray-600"
            name="q"
        ...
        <div className="filter-group">
          ...
          <div className="form-check">
            <input
              ...
              onChange={(e) => handleFilterChange(e)}
            />
            <label className="form-check-label trip-text-m" htmlFor="certifiedHost">
              真安心團主認證
            </label>
          </div>
        </div>
        <div className="updateBtn-container">
          <button
            className="btn trip-btn-primary trip-btn-l"
            type="button"
...
function TripCard({ data: trip }) {
  ...
  const handleDisplayVacancy = ({ max_people, current_participants }) => {
    ...
    return (
      <div className="status-box status-available d-flex align-items-center flex-shrink-0">
          ...
          <div className="contentBox">
            <div className="tags-container d-flex">
              {trip.tags.map((tag, index) => (
                <Tag text={tag} key={`${trip.id}_${index}_${tag}`} />
              ))}
            </div>
            ...
            <div className="trip-info-container">
              ...
              <div className="d-flex align-items-center">
                ...
                <span className="trip-text-s">
                  {handleDisplayDate({ start_date: trip.start_date, end_date: trip.end_date })}
                </span>
              </div>
            </div>
...
function Tag({ text }) {
  return (
    <div className="trip-tag d-flex justify-content-center align-items-center">
          ...
          <ul className="pagination justify-content-center">
            ...
            {Array.from({ length: totalPages }, (_, i) => i + 1).map((idx) => {
              return (
                ...
                >
                  <a className="page-link trip-text-primary-1000" href="#">
                    {idx}
                  </a>
                </li>
              );
