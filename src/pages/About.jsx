          ...
          <div className="about-story-grid">
            <div className="about-story-images">
              <div
                ...
                style={{
                  backgroundImage:
                    "url('https://images.unsplash.com/photo-1501555088652-021faa106b9b?q=80&w=800&fit=crop')",
                }}
              ></div>
              <div
                ...
                style={{
                  backgroundImage:
                    "url('https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=400&fit=crop')",
                }}
              ></div>
            ...
            <div className="about-story-content">
              ...
              <p className="about-story-text">
                2025 年，UNO
                在一次獨自旅行中，在合歡山的山頂上，望著壯觀的雲海，心裡卻有一種說不出的遺憾——
                <strong>如果這一刻有個人能一起分享，該有多好。</strong>
              </p>
              <p className="about-story-text">
                那一刻，TripSeat
                的種子悄悄萌芽。我們相信，最美的風景需要有人共同欣賞，最好的旅行需要有旅伴相陪。
              </p>
              <p className="about-story-text">
      ...
      <section className="about-values">
        <div className="container">
          <div className="about-section-header">
            ...
            <p className="about-section-desc">每個設計決定、每個功能，都來自這三個核心信念</p>
          </div>
      ...
      <section className="about-team">
        <div className="container">
          <div className="about-section-header">
            ...
            <p className="about-section-desc">一群對旅行充滿熱情的人，用心打造讓旅行更美好的平台</p>
          </div>
          ...
          <div className="about-contact-grid">
            ...
            <div className="about-cta-card">
              ...
              <div className="about-cta-badges">
                <span>
                  <i className="bi bi-shield-check-fill"></i> 安全認證
                </span>
                <span>
                  <i className="bi bi-star-fill"></i> 4.9 評分
                </span>
                <span>
                  <i className="bi bi-people-fill"></i> 18K+ 會員
                </span>
              </div>
            </div>
          </div>
