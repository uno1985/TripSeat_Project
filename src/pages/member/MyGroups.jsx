  ...
  return (
    <div className="my-groups-section my-5">
      <div className="d-flex justify-content-between align-items-center mb-4 mx-2">
        ...
        <Link to="/member/groups" className="trip-text-m link-m link-underline-gray-600">
          查看更多
        </Link>
      </div>
      ...
      <div className="row g-4">
        {groups.length === 0 ? (
          <div>
            <div className="text-center py-4 text-muted">目前還沒有你建立的揪團</div>
          </div>
        ) : (
          groups.map((group) => (
            <div key={group.id} className="col-md-4">
              <div className="card">
                ...
                <div className="position-relative">
                  ...
                  <span
                    className={`position-absolute top-0 start-0 m-3 badge px-2 py-1 fw-normal ${group.statusClass}`}
                  >
                    {group.status}
                  </span>
                  {group.remaining && (
                ...
                <div className="card-body p-3">
                  <h5 className="card-title h5 text-truncate-2">{group.title}</h5>
                  ...
                  <div className="d-flex align-items-center small">
                    ...
                    <span className="text-muted">
                      已有 <span className="fw-bold text-dark">{group.participants}</span>{' '}
                      位乘客加入
                    </span>
                  </div>
                </div>
