...
function TripDetail() {
    ...
    try {
      ...
      const applicants = (tripParticipantsRes.data || [])
        ...
        .map((row) => ({
          ...
          avatar:
            userMap.get(row.user_id)?.avatar ||
  ...
  const allImages = [trip.image_url, ...(trip.related_images || [])].filter(Boolean).slice(0, 5);
  ...
  return (
    <div className="trip-detail-page">
      ...
      <div className="container pt-5">
        {/* Breadcrumb */}
        <Breadcrumb
          items={[{ label: '首頁', path: '/' }, { label: '探索旅程' }, { label: t.title }]}
        />
            ...
            <div className="d-flex align-items-center gap-2">
              {trip.owner_id === user?.id && (
                <Link
                  ...
                  className="link-m trip-text-gray-600 edit-link"
                >
                  編輯旅程
                </Link>
              )}
              ...
              >
                <span
                  className={`material-symbols-outlined trip-favorite-icon ${favoriteId ? 'is-active' : ''}`}
                >
                  favorite
                </span>
              </button>
        ...
        <div className="row g-4">
          ...
          <div className="col-lg-8">
              ...
              <div className="info-card">
                <div className="info-grid">
                  <div className="info-item">
                    ...
                    <span className="info-value trip-text-s trip-text-gray-800">
                      {t.info.dates}
                    </span>
                  </div>
                  <div className="info-item">
            ...
            {t.images.length > 0 && (
              <div className="gallery-section mb-4">
                ...
                <div className="hero-image-wrapper">
                  <img src={t.images[selectedImageIndex]} alt="主圖" className="hero-image" />
                </div>
                {/* 縮圖列表 (最多 5 張，包含主圖) */}
                {t.images.length > 1 && (
            ...
            <div className="section-block about-section mb-4">
              ...
              <p className="trip-text-m trip-text-gray-600 mb-4" style={{ whiteSpace: 'pre-line' }}>
                {t.description}
              </p>
              ...
              <div className="section-block itinerary-section">
                ...
                <div className="timeline-container">
                  {t.itinerary.map((item, idx) => (
                    <div
                      key={idx}
                      className={`timeline-item ${idx === t.itinerary.length - 1 ? 'last' : ''}`}
                    >
                      ...
                      <div className="timeline-content">
                        ...
                        {item.desc && (
                          <p className="timeline-desc trip-text-s trip-text-gray-600">
                            {item.desc}
                          </p>
                        )}
                      </div>
              ...
              {user ? (
                <>
                  ...
                  <div className="sidebar-card booking-card mb-4">
                    ...
                    <button
                      className="trip-btn-primary trip-btn-l cta-button"
                      disabled={isCtaDisabled || applying}
                      onClick={() => openJoin(trip)}
                    >
                ...
                <div className="sidebar-card booking-card mb-4 text-center py-4">
                  ...
                  <p className="trip-text-s trip-text-gray-400 mt-3 mb-0">
                    還沒有帳號？
                    <Link to="/register" className="trip-text-primary">
                      免費註冊
                    </Link>
                  </p>
                </div>
                ...
                <>
                  <div className="sidebar-card applicants-card">
                    ...
                    <div className="applicants-row">
                      ...
                      <Link to={`/member/groups?tripId=${trip.id}`} className="manage-btn">
                        管理
                      </Link>
                    </div>
                  </div>
                  ...
                  <div className="mb-4">
                    ...
                    <div className="d-flex align-items-center gap-3">
                      ...
                      <button
                        ...
                        disabled={
                          applying ||
                          pax >= (trip?.max_people || 0) - (trip?.current_participants || 0)
                        }
                      >
                        ＋
                      </button>
                      ...
                      <span className="trip-text-s trip-text-gray-400">
                        人&ensp;·&ensp;剩餘{' '}
                        <strong className="trip-text-gray-600">
                          {(trip?.max_people || 0) - (trip?.current_participants || 0)}
                        </strong>{' '}
                        個名額
                      </span>
