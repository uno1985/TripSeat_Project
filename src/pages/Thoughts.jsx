  ...
  const fetchReviews = async () => {
    ...
    try {
      const res = await axios.get(
        `${API_URL}/664/reviews?is_public=true&_sort=created_at&_order=desc`
      );
      // 過濾掉已刪除的心得
  ...
  return (
    <div className="thoughts-page">
      <div className="container pt-5">
        {/* Breadcrumb */}
        <Breadcrumb items={[{ label: '首頁', path: '/' }, { label: '回憶旅程' }]} />
            ...
            {reviews.map((review) => (
              ...
              >
                ...
                <div className="card-content-box">
                  {/* 旅程標題 */}
                  <h3 className="card-title trip-text-gray-800">{review.trip_title}</h3>

                  {/* 評分 */}
                  <div className="card-rating mb-2">{renderStars(review.rating)}</div>
