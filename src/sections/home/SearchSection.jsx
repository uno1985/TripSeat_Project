        ...
        <div className="container">
          <div className="main">
            ...
            <div className="image-box d-flex justify-content-between align-items-end">
              <div>
                <img src={Image1157} className="img-fluid" alt="旅遊風景" />
              </div>
              <div>
                <img src={Image1156} className="img-fluid" alt="旅遊風景" />
              </div>
              <div>
                <img src={Image1775} className="img-fluid" alt="旅遊風景" />
              </div>
              <div>
                <img src={Image996} className="img-fluid" alt="旅遊風景" />
              </div>
            </div>
          </div>
        </div>
...
function SearchBar() {
  ...
  return (
    <div className="searchBar d-flex">
      ...
      <div
        className="searchBtn-box flex-shrink-0"
        onClick={() => {
