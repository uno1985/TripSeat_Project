...
const introData = [
  ...
  },
  {
    ...
    title: '可以​搜尋​加入​',
    content:
      '透過關​鍵字​搜尋​你​感興趣​的​旅程，​立即​申請​加入！​待團主同​意後即​可​成功​報名、​準備​出發。​',
    stepImg: Step2,
  ...
  },
  {
    ...
    title: '可以​創建​旅程​',
    content:
      '建立​你​的​旅程，​找到​願意​一起​同行​的​夥伴。​有​人​申請時，​你​也​有​權​可​審核​是否​加入。​',
    stepImg: Step3,
...
function IntroCard({ data }) {
  return (
    <div className="introCard col-md-3 d-flex flex-column justify-content-center align-items-center">
      <div className="stepImg-box">
        <img src={data.stepImg} className="w-100" alt={`步驟${data.step}`} />
      </div>
      <div className="mainImg-box">
        <img src={data.mainImg} className="w-100" alt={data.title} />
      </div>
