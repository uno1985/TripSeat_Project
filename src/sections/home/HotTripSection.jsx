                                ...
                                <div className="d-flex py-3 position-relative">
                                    ...
                                    <div className="flex-grow-1 ms-3">
                                        <div className="d-flex justify-content-between align-items-start">
                                            ...
                                            <span className="trip-text-m trip-text-gray-400">136人瀏覽</span>
                                        </div>
                                        
                                        <div className="mb-1">
                                            <p className="trip-text-m mb-1 d-flex align-items-center">
                                                <img src="public/assets/location.svg" className="me-2" alt="" />
                                                <span>台北 101 大樓 1F</span>
                                            </p>
                                            <p className="trip-text-m mb-0">
                                                <img src="public/assets/time.svg" className="me-2" alt="" />
                                                <span>2025/12/31 23:00</span>
                                            </p>
                                        </div>

                                        {/* 剩餘位數標籤 (絕對定位在右下角) */}
                                        <div className="lastSeat position-absolute bottom-0 end-0 px-2 py-1 trip-text-m">
                                            剩餘 1 位
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="d-flex py-3 position-relative">
                                    ...
                                    <div className="flex-grow-1 ms-3">
                                        <div className="d-flex justify-content-between align-items-start">
                                            ...
                                            <span className="trip-text-m trip-text-gray-400">36人瀏覽</span>
                                        </div>
                                ...
                                <div className="d-flex py-3 position-relative">
                                    ...
                                    <div className="flex-grow-1 ms-3">
                                        <div className="d-flex justify-content-between align-items-start">
                                            ...
                                            <span className="trip-text-m trip-text-gray-400">236人瀏覽</span>
                                        </div>
                                ...
                                <div className="d-flex py-3 position-relative">
                                    ...
                                    <div className="flex-grow-1 ms-3">
                                        <div className="d-flex justify-content-between align-items-start">
                                            ...
                                            <span className="trip-text-m trip-text-gray-400">12/12 開團</span>
                                        </div>
                                ...
                                <div className="d-flex py-3 position-relative">
                                    ...
                                    <div className="flex-grow-1 ms-3">
                                        <div className="d-flex justify-content-between align-items-start">
                                            ...
                                            <span className="trip-text-m trip-text-gray-400">12/08 開團</span>
                                        </div>
                                ...
                                <div className="d-flex py-3 position-relative">
                                    ...
                                    <div className="flex-grow-1 ms-3">
                                        <div className="d-flex justify-content-between align-items-start">
                                            ...
                                            <span className="trip-text-m trip-text-gray-400">12/07 開團</span>
                                        </div>
