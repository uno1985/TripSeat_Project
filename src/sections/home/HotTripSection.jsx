          ...
          <div className="d-flex pt-3 position-relative">
            ...
            <div className="flex-grow-1 ms-3">
              <div className="d-flex justify-content-between align-items-start">
                ...
                <span className="trip-text-m trip-text-gray-400 desktop-show">{desktopMeta(trip)}</span>
              </div>
              ...
              <div className="d-flex align-items-center justify-content-end flex-row px-2 py-1">
                <span className="trip-text-m trip-text-gray-400 me-3 mobile-show">{mobileMeta(trip)}</span>
