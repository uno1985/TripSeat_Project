  ...
  return (
    <div className="footer container pt-52">
      <div className="d-flex justify-content-between pb-60 flex-md-row flex-column">
        ...
        <div className="">
          <Link to="/about" className="mr-8 footerLink">
            關於我們
          </Link>
          <Link to="/legal#terms" className="mr-8 footerLink">
            使用條款
          </Link>
          <Link to="/legal#privacy" className="mr-8 footerLink">
            隱私政策
          </Link>
          <Link to="/legal#faq" className="mr-8 footerLink">
            常見問題
          </Link>
        </div>
