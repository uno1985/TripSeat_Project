...
function DatePicker({ editable, onDateChange, className, fontStyle }) {
        ...
        <Popover.Root>
          <Popover.Trigger asChild>
            <button className={`datePicker-input d-flex ${className}`}>
              <div className={`flex-grow-1 ${fontStyle}`}>{handleDateDisplay()}</div>
